// ============================================
  ...
  window.__PRODUCT_PHOTOS = {
    ...
    'ee-matty-boy-shorts-black-blue': 'assets/images/ee-matty-boy-shorts-black-blue.jpg',
    'ee-bape-miami-short-brown-yellow': 'assets/images/ee-bape-miami-short-brown-yellow.jpg',
    'ee-basic-short-carolina-bolt': 'assets/images/ee-basic-short-carolina-bolt.jpg',
    'ee-basic-short-red-bolt': 'assets/images/ee-basic-short-red-bolt.jpg',
    'ee-bape-short-red': 'assets/images/ee-bape-short-red.jpg',
    'ee-clover-short-navy-green': 'assets/images/ee-clover-short-navy-green.jpg',
    'ee-basic-short-royal-paisley': 'assets/images/ee-basic-short-royal-paisley.jpg',
    'ee-basic-short-lilac-sky': 'assets/images/ee-basic-short-lilac-sky.jpg',
    'ee-valentines-kiss-short-purple': 'assets/images/ee-valentines-kiss-short-purple.jpg',
    'ee-basic-lightning-bolt-short-navy': 'assets/images/ee-basic-lightning-bolt-short-navy.jpg',
  ...
  const BRANDS = {
    ...
    'eric-emanuel': { name: 'Eric Emanuel', count: 10, desc: "Eric Emanuel's NYC label — basketball-inspired sportswear best known for the mesh EE Short. Collegiate color-blocking and team-prep motifs since 2015." },
    alocs: { name: 'ALOCS', count: 0, desc: "Lil Yachty's Awful Lot of Cough Syrup. Codeine-coded palette, retro-bootleg graphics, and Atlanta-rap visual culture rendered into pieces you can wear." },
    alo: { name: 'Alo', count: 0, desc: "LA athleisure-turned-streetwear staple. Premium set bottoms, oversized lifter sweatshirts, and elevated everyday basics — established 2007 and now ubiquitous in the celebrity off-duty rotation." },
    'bravest-studios': { name: 'Bravest Studios', count: 0, desc: "The Bravest Shorts house — mesh basketball silhouettes remixed with bootleg-style sports graphics. Drop-driven, irreverent, instantly recognizable." },
    godspeed: { name: 'Godspeed', count: 0, desc: "Emerging streetwear label. Listings authenticated and graded by Shopped By Thread." },
  };

  // Category metadata. Slugs match the `category` field on each product.
  const CATEGORIES = {
    tees: { name: 'Tees', desc: "Short and long-sleeve tees from every brand in the catalog. Heavyweight cotton, graphic prints, and box-fit silhouettes." },
    'hoodies-sweats': { name: 'Hoodies & Sweats', desc: "Pullover hoodies, zip-ups, crewnecks, and track jackets. The heavyweight French terry layer that defines streetwear." },
    bottoms: { name: 'Bottoms', desc: "Cargo pants, shorts, sweatpants, and denim. The grounded half of any fit." },
    footwear: { name: 'Footwear', desc: "Sneakers and canvas low-tops. Authenticated and graded before listing." },
    accessories: { name: 'Accessories', desc: "The smaller pieces that complete the rotation — boxer briefs, bags, hats, and more as we expand." },
  };
  ...
  const PRODUCTS = {
    ...
    /* TEMP REMOVED — no photo yet. Uncomment to restore.
   ...
   'bape-inter-miami-camo-tee-black': {
    ...
    // ----- Eric Emanuel — mesh basketball shorts -----
    'ee-matty-boy-shorts-black-blue': {
      brand: 'eric-emanuel',
      category: 'bottoms',
      name: 'EE × Matty Boy Shorts — Black / Blue',
      price: 68,
      cond: 'Brand New / Tagged',
      condDetail: 'Item is brand new with original tags attached.',
      variant: 'ink',
      sizes: { S: 'avail', M: 'avail', L: 'avail', XL: 'avail' },
      desc: "Eric Emanuel × Matty Boy collab. Black mesh basketball short with cartoonist Matty Boy's signature graffiti graphics — Radio, Riot, Chaos — printed across the front. The cult crossover between two NY scenes.",
    },
    'ee-bape-miami-short-brown-yellow': {
      brand: 'eric-emanuel',
      category: 'bottoms',
      name: 'EE × BAPE Miami Basic Short — Brown / Yellow',
      price: 68,
      cond: 'Brand New / Tagged',
      condDetail: 'Item is brand new with original tags attached.',
      variant: 'rust',
      tag: 'Grail',
      sizes: { S: 'avail', M: 'avail', L: 'avail', XL: 'avail' },
      desc: "Eric Emanuel × BAPE Miami capsule. The signature EE mesh basketball silhouette meets BAPE's iconic 1st camo in a brown and yellow Miami palette. Collab grail, brand new with original tags.",
    },
    'ee-basic-short-carolina-bolt': {
      brand: 'eric-emanuel',
      category: 'bottoms',
      name: 'EE Basic Short — Carolina Bolt',
      price: 68,
      cond: 'Brand New / Tagged',
      condDetail: 'Item is brand new with original tags attached.',
      variant: 'blue',
      sizes: { S: 'avail', M: 'avail', L: 'avail', XL: 'avail' },
      desc: "Eric Emanuel's lightning bolt mesh short in Carolina blue. Heavyweight mesh, EE side patch, drawstring waist — the bolt graphic running down each leg. Brand new with tags.",
    },
    'ee-basic-short-red-bolt': {
      brand: 'eric-emanuel',
      category: 'bottoms',
      name: 'EE Basic Short — Red Bolt',
      price: 68,
      cond: 'Brand New / Tagged',
      condDetail: 'Item is brand new with original tags attached.',
      variant: 'red',
      sizes: { S: 'avail', M: 'avail', L: 'avail', XL: 'avail' },
      desc: "Eric Emanuel's iconic lightning bolt mesh short in classic red. The shape that defined the brand — heavyweight mesh, EE side patch, drawstring waist, bolt graphic running down each leg.",
    },
    'ee-bape-short-red': {
      brand: 'eric-emanuel',
      category: 'bottoms',
      name: 'EE × BAPE Basic Short — Red',
      price: 68,
      cond: 'Brand New / Tagged',
      condDetail: 'Item is brand new with original tags attached.',
      variant: 'red',
      tag: 'Grail',
      sizes: { S: 'avail', M: 'avail', L: 'avail', XL: 'avail' },
      desc: "Eric Emanuel × BAPE in heritage red. EE's mesh basketball short with BAPE's iconic camo pattern in deep red — collab royalty. Brand new with original tags.",
    },
    'ee-clover-short-navy-green': {
      brand: 'eric-emanuel',
      category: 'bottoms',
      name: 'EE Clover Short — Navy / Green',
      price: 68,
      cond: 'Brand New / Tagged',
      condDetail: 'Item is brand new with original tags attached.',
      variant: 'blue',
      sizes: { S: 'avail', M: 'avail', L: 'avail', XL: 'avail' },
      desc: "Eric Emanuel's Clover Short in navy mesh with a green four-leaf clover patch. EE's St. Patty's run, brand new with original tags.",
    },
    'ee-basic-short-royal-paisley': {
      brand: 'eric-emanuel',
      category: 'bottoms',
      name: 'EE Basic Short — Royal Paisley',
      price: 68,
      cond: 'Brand New / Tagged',
      condDetail: 'Item is brand new with original tags attached.',
      variant: 'blue',
      sizes: { S: 'avail', M: 'avail', L: 'avail', XL: 'avail' },
      desc: "Eric Emanuel's paisley print in royal blue. Bandana-coded pattern across the signature EE mesh basketball silhouette. Brand new with original tags.",
    },
    'ee-basic-short-lilac-sky': {
      brand: 'eric-emanuel',
      category: 'bottoms',
      name: 'EE Basic Short — Lilac Sky',
      price: 68,
      cond: 'Brand New / Tagged',
      condDetail: 'Item is brand new with original tags attached.',
      variant: 'bone',
      sizes: { S: 'avail', M: 'avail', L: 'avail', XL: 'avail' },
      desc: "Eric Emanuel's Lilac Sky colorway — purple-to-blue cloud print on the signature EE mesh short. Pastel side of the EE palette. Brand new with tags.",
    },
    'ee-valentines-kiss-short-purple': {
      brand: 'eric-emanuel',
      category: 'bottoms',
      name: "EE Valentine's Kiss Short — Purple",
      price: 68,
      cond: 'Brand New / Tagged',
      condDetail: 'Item is brand new with original tags attached.',
      variant: 'stone',
      sizes: { S: 'avail', M: 'avail', L: 'avail', XL: 'avail' },
      desc: "Eric Emanuel's Valentine's Day capsule — purple mesh with kiss print throughout. Limited holiday drop, brand new with original tags.",
    },
    'ee-basic-lightning-bolt-short-navy': {
      brand: 'eric-emanuel',
      category: 'bottoms',
      name: 'EE Lightning Bolt Short — Navy / Black / Teal',
      price: 68,
      cond: 'Brand New / Tagged',
      condDetail: 'Item is brand new with original tags attached.',
      variant: 'ink',
      sizes: { S: 'avail', M: 'avail', L: 'avail', XL: 'avail' },
      desc: "Eric Emanuel's lightning bolt mesh short in a moody navy, black, and teal colorway. Heavyweight mesh basketball silhouette with the bolt graphic running down each leg.",
    },
  };
  ...
  function productsByCategory(categorySlug) {
    return Object.entries(PRODUCTS)
      .filter(([_, p]) => p.category === categorySlug)
      .map(([id, p]) => ({ id, ...p }));
  }
 ...
 // ============================================
  ...
  function navigate(view, params = {}) {
    ...
    // History sync — push a new entry unless we're responding to a popstate
    // (i.e., the user just pressed back/forward in the browser).
    if (!params._fromPopState) {
      try {
        history.pushState({ view, params }, '', '');
      } catch (e) { /* no-op if pushState fails (e.g. sandboxed) */ }
    }
    ...
    if (view === 'category') hydrateCategory(params.category || 'tees');
  ...
  // ----- BROWSER HISTORY (back/forward inside the SPA) -----
  // Replace the initial blank entry so the user is "on" home view in history.
  try {
    history.replaceState({ view: 'home' }, '', '');
  } catch (e) { /* no-op */ }

  // When the user presses back/forward, the browser fires popstate with the
  // state object we pushed. Re-run navigate without pushing a new entry.
  window.addEventListener('popstate', (e) => {
    const s = e.state;
    if (s && s.view) {
      navigate(s.view, { ...(s.params || {}), _fromPopState: true });
    } else {
      // Fell off the start of our pushed history — go home.
      navigate('home', { _fromPopState: true });
    }
  });
  ...
  document.body.addEventListener('click', (e) => {
    ...
    navigate(navEl.dataset.nav, {
      ...
      category: navEl.dataset.category,
  ...
  // ============================================
  // CATEGORY FILTERS + HYDRATE  (Deploy 2)
  // ============================================
  // Mirror of brand filter state — kept separate so user can have
  // different filters set on a brand page vs a category page.
  ...
  let _activeCategorySlug = null;

  function applyCategoryFilters(items) {
    let filtered = items.slice();
    if (categoryFilters.inStockOnly) {
      filtered = filtered.filter(p =>
        Object.values(p.sizes).some(s => s !== 'sold')
      );
    }
    if (categoryFilters.size) {
      filtered = filtered.filter(p =>
        p.sizes[categoryFilters.size] && p.sizes[categoryFilters.size] !== 'sold'
      );
    }
    if (categoryFilters.price) {
      const [min, max] = categoryFilters.price.split('-').map(Number);
      filtered = filtered.filter(p => p.price >= min && p.price <= max);
    }
    if (categoryFilters.sort === 'price-low') filtered.sort((a, b) => a.price - b.price);
    else if (categoryFilters.sort === 'price-high') filtered.sort((a, b) => b.price - a.price);
    else if (categoryFilters.sort === 'name') filtered.sort((a, b) => a.name.localeCompare(b.name));
    return filtered;
  }

  function hydrateCategory(slug) {
    const cat = CATEGORIES[slug];
    if (!cat) return;
    _activeCategorySlug = slug;
    const liveCount = productsByCategory(slug).length;
    document.getElementById('category-name').textContent = cat.name;
    document.getElementById('category-crumb').textContent = cat.name;
    document.getElementById('category-count').textContent = liveCount;
    document.getElementById('category-desc').textContent = cat.desc;
    renderCategoryGrid();
  }

  function renderCategoryGrid() {
    if (!_activeCategorySlug) return;
    const allItems = productsByCategory(_activeCategorySlug);
    const items = applyCategoryFilters(allItems);
    document.getElementById('category-filter-count').textContent = `${items.length} result${items.length !== 1 ? 's' : ''} shown`;
...
const displayPrice = isWholesale ? wholesalePriceAtTier(p.price, currentCartTier()) : p.price;      const orig = `Add to cart — $${displayPrice}`;
  ...
  function renderCart() {
    ...
    const linesHTML = state.cart.map((item, idx) => {
      ...
      // Photo lookup: direct id first, then legacy short-key map
      let photoB64 = window.__PRODUCT_PHOTOS?.[item.productId];
      if (!photoB64) {
        const photoKey = PHOTO_KEY_BY_PRODUCT_ID[item.productId];
        photoB64 = photoKey ? window.__PRODUCT_PHOTOS?.[photoKey] : null;
      }
      const imgInner = photoB64
        ? `<img src="${photoB64}" alt="${p.name}" style="width:100%;height:100%;object-fit:cover;display:block;">`
        : brand.name;
      return `
        <div class="cart-line">
          <div class="cart-line__img cart-line__img--${p.variant}" data-nav="product" data-product="${item.productId}">${imgInner}</div>
          <div>
  ...
  // Brand bar links are wired declaratively via data-nav attributes in HTML.
  // The Brands dropdown trigger is handled separately below.

  // ============================================
  // BRANDS DROPDOWN — build alphabetical panel + toggle
  // ============================================
  function buildBrandsDropdown() {
    const grid = document.getElementById('brands-dropdown-grid');
    if (!grid) return;
    // Group brands by first letter of display name
    const byLetter = {};
    Object.entries(BRANDS).forEach(([slug, b]) => {
      const letter = (b.name[0] || '#').toUpperCase();
      if (!byLetter[letter]) byLetter[letter] = [];
      byLetter[letter].push({ slug, name: b.name });
    });
    // Sort within each letter group, then sort letters
    Object.values(byLetter).forEach(arr => arr.sort((a, b) => a.name.localeCompare(b.name)));
    const letters = Object.keys(byLetter).sort();
    grid.innerHTML = letters.map(L => `
      <div class="brands-dropdown__group">
        <div class="brands-dropdown__letter">${L}</div>
        <div class="brands-dropdown__list">
          ${byLetter[L].map(b => `<a class="brands-dropdown__brand" href="javascript:void(0)" data-nav="brand" data-brand="${b.slug}">${b.name}</a>`).join('')}
        </div>
      </div>
    `).join('');
  }
  ...
  // Wire the BRANDS ▾ trigger to toggle the panel
  const brandsTrigger = document.getElementById('brands-trigger');
  const brandsDropdown = document.getElementById('brands-dropdown');
  function setBrandsDropdownOpen(open) {
    if (!brandsTrigger || !brandsDropdown) return;
    brandsTrigger.classList.toggle('is-open', open);
    brandsDropdown.classList.toggle('is-open', open);
    brandsDropdown.setAttribute('aria-hidden', open ? 'false' : 'true');
  }
  if (brandsTrigger) {
    brandsTrigger.addEventListener('click', (e) => {
      e.preventDefault();
      e.stopPropagation();
      setBrandsDropdownOpen(!brandsTrigger.classList.contains('is-open'));
    });
  }
  // Close on click inside (after a brand is picked) or click outside.
  // Brand clicks bubble up through the dropdown — close it after navigation fires.
  document.addEventListener('click', (e) => {
    if (!brandsTrigger || !brandsDropdown) return;
    if (!brandsTrigger.classList.contains('is-open')) return;
    if (e.target.closest('#brands-trigger')) return;
    // Click on a brand link inside the dropdown: close after handling
    if (e.target.closest('.brands-dropdown__brand')) {
  ...
  document.addEventListener('keydown', (e) => {
    if (e.key === 'Escape' && brandsTrigger?.classList.contains('is-open')) {
      setBrandsDropdownOpen(false);
    }
  });
  ...
  // ============================================
  // QUICK VIEW — first click on a .product card opens a preview modal.
  // Clicking the modal navigates to the full product page.
  // ============================================
  const QV_PHOTO_KEY_BY_PRODUCT_ID = {
    'hellstar-records-iii': 'hellstar',
    'gallery-dept-gpatch': 'galleryDept',
    'vale-forever-classico': 'valeForever',
    'vale-forever-devils': 'valeDevils',
  ...
  function openQuickview(productId) {
    ...
    // Photo lookup: direct id first, then legacy short-key map
    let photoB64 = window.__PRODUCT_PHOTOS?.[productId];
    if (!photoB64) {
      const photoKey = QV_PHOTO_KEY_BY_PRODUCT_ID[productId];
      photoB64 = photoKey ? window.__PRODUCT_PHOTOS?.[photoKey] : null;
    }
    const photoHTML = photoB64
      ? `<img class="quickview__photo" src="${photoB64}" alt="${p.name}">`
      : `<div class="quickview__photo-placeholder">${brand.name}</div>`;

    const isWholesale = document.body.classList.contains('is-wholesale');
    const displayPrice = isWholesale
      ? wholesalePriceAtTier(p.price, currentCartTier())
      : p.price;
    const priceWasHTML = p.priceWas
      ? `<span class="quickview__price-was">$${p.priceWas}</span>`
      : '';

    const modal = document.getElementById('quickview-modal');
    if (!modal) return;
    modal.innerHTML = `
      <div class="quickview__backdrop" data-quickview-close></div>
      <div class="quickview__panel" data-quickview-product="${productId}">
        <button class="quickview__close" data-quickview-close aria-label="Close quick view">×</button>
        <div class="quickview__photo-wrap">${photoHTML}</div>
        <div class="quickview__info">
          <div class="quickview__brand">${brand.name}</div>
          <h3 class="quickview__name">${p.name}</h3>
          <div class="quickview__price">$${displayPrice}${priceWasHTML}</div>
          <div class="quickview__cta">Tap anywhere to view full details →</div>
        </div>
      </div>
    `;
    ...
    document.body.classList.add('quickview-locked');

    // Wire click on panel → navigate to full product page
    const panel = modal.querySelector('.quickview__panel');
    panel.addEventListener('click', (e) => {
      // Ignore clicks on the close button (handled separately)
      if (e.target.closest('[data-quickview-close]')) return;
      closeQuickview();
      navigate('product', { product: productId });
    });

    // Wire close buttons (backdrop + X)
    modal.querySelectorAll('[data-quickview-close]').forEach(el => {
      el.addEventListener('click', (e) => {
        e.stopPropagation();
        closeQuickview();
      });
  ...
  function closeQuickview() {
    ...
    document.body.classList.remove('quickview-locked');
    setTimeout(() => {
      modal.classList.remove('is-open', 'is-closing');
      modal.setAttribute('aria-hidden', 'true');
      modal.innerHTML = '';
    }, 200); // matches the closing animation duration
  }
  ...
  document.addEventListener('keydown', (e) => {
    if (e.key === 'Escape') {
      const modal = document.getElementById('quickview-modal');
      if (modal?.classList.contains('is-open')) closeQuickview();
    }
  });

  // Intercept clicks on .product cards BEFORE the global data-nav delegation
  // fires (capture phase + stopImmediatePropagation). Without this, the card
  // would navigate straight to the product page on the very first click.
  document.body.addEventListener('click', (e) => {
    // Don't intercept if we're already inside the quickview modal
    if (e.target.closest('#quickview-modal')) return;
    // Don't intercept the size-pill quick-add buttons inside cards
    if (e.target.closest('.product__size')) return;
  ...
  // BRAND PAGE FILTERS
  // ============================================
  function initFilterPill(pillId, dropdownId, valueId, filterKey, labelMap, state, renderFn) {
    const pill = document.getElementById(pillId);
    const dropdown = document.getElementById(dropdownId);
    const valueEl = document.getElementById(valueId);
    if (!pill || !dropdown) return;
    // Default state + renderFn for backwards compat (brand filters)
    if (!state) state = brandFilters;
    if (!renderFn) renderFn = renderBrandGrid;
  ...
  // Category-page filter pills (mirror of brand filters, separate state)
  initFilterPill('cat-filter-sort', 'cat-filter-sort-dropdown', 'cat-filter-sort-value', 'sort', {
    'newest': 'Newest', 'price-low': 'Price ↑', 'price-high': 'Price ↓', 'name': 'A → Z'
  }, categoryFilters, renderCategoryGrid);
  initFilterPill('cat-filter-size', 'cat-filter-size-dropdown', 'cat-filter-size-value', 'size', {
    '': 'Size', 'S': 'Size: S', 'M': 'Size: M', 'L': 'Size: L', 'XL': 'Size: XL'
  }, categoryFilters, renderCategoryGrid);
  initFilterPill('cat-filter-price', 'cat-filter-price-dropdown', 'cat-filter-price-value', 'price', {
    '': 'Price', '0-200': 'Under $200', '200-400': '$200 — $400', '400-600': '$400 — $600', '600-99999': '$600+'
  }, categoryFilters, renderCategoryGrid);

  // In-stock toggle pill (brand)
  ...
  // In-stock toggle pill (category)
  const catStockPill = document.getElementById('cat-filter-stock');
  if (catStockPill) {
    catStockPill.addEventListener('click', () => {
      categoryFilters.inStockOnly = !categoryFilters.inStockOnly;
      catStockPill.classList.toggle('active', categoryFilters.inStockOnly);
      renderCategoryGrid();
    });
  }
  ...
  // Note: the gate's "Apply" buttons (gate-apply-btn-a / gate-apply-btn-b)
  // are wired in the WHOLESALE GATE section below.
  ...
  function populateOrderSummary() {
    ...
    const linesHTML = state.cart.map(item => {
      ...
      const displayPrice = isWholesale ? wholesalePriceAtTier(p.price, summaryTier) : p.price;
      ...
      const thumbHTML = photoB64
        ? `<img class="request-order-line__thumb" src="${photoB64}" alt="${p.name}" style="width:48px;height:60px;object-fit:cover;display:block;border-radius:2px;flex-shrink:0;">`
        : '';
      return `
...
const displayPrice = isWholesale ? wholesalePriceAtTier(p.price, submitTier) : p.price;      subtotal += displayPrice;
  ...
  async function initClerk() {
    ...
    try {
      ...
      updateAuthUI();
      // Apply wholesale state based on whether user has wholesale flag
      if (typeof applyWholesaleState === 'function') applyWholesaleState();
  ...
  async function socialSignIn(strategy) {
    if (!clerkReady) {
      // Surface what's wrong instead of failing silently
      const msg = window.Clerk
        ? 'Auth still loading — try again in a moment'
        : 'Sign-in not yet configured — check back soon';
      setAuthStatus('auth-signin-status', msg, 'err');
      setAuthStatus('auth-signup-status', msg, 'err');
      console.warn('[auth] Social sign-in attempted before Clerk ready. window.Clerk =', window.Clerk);
      return;
    }
    try {
      ...
      setAuthStatus('auth-signin-status', err?.errors?.[0]?.longMessage || err?.errors?.[0]?.message || 'Social sign-in failed', 'err');
    }
  }
  ...
  // ============================================
  // WHOLESALE GATE (Clerk-based access)
  // ============================================
  // Access is granted via Clerk publicMetadata.wholesale === true.
  // Set this flag in the Clerk dashboard for approved wholesale partners.
  // No shared passcode lives in this file — anything in here is publicly
  // viewable, so the source of truth must be server-side in Clerk.

  const gate = document.getElementById('gate');
  const gateStateLoggedOut = document.getElementById('gate-state-loggedout');
  const gateStatePending = document.getElementById('gate-state-pending');
  const gateUserNameEl = document.getElementById('gate-user-name');

  // Truthy if the currently-signed-in Clerk user is approved for wholesale.
  function isWholesaleApproved() {
    return clerkUser?.publicMetadata?.wholesale === true;
  }

  // Render the gate in the right state based on Clerk auth + approval status.
  function renderGateState() {
    if (!gate) return;
    if (!clerkUser) {
      // Logged out — show sign in / apply
      gateStateLoggedOut.style.display = '';
      gateStatePending.style.display = 'none';
    } else if (!isWholesaleApproved()) {
      // Logged in but not approved — show pending / apply
      gateStateLoggedOut.style.display = 'none';
      gateStatePending.style.display = '';
      const first = clerkUser.firstName || clerkUser.username
        || clerkUser.primaryEmailAddress?.emailAddress?.split('@')[0]
        || 'there';
      if (gateUserNameEl) gateUserNameEl.textContent = first;
    } else {
      // Logged in AND approved — gate shouldn't be open; close it just in case
      gate.classList.remove('active');
    }
  }

  // Apply wholesale styling site-wide based on Clerk approval flag.
  // Called whenever auth state changes.
  function applyWholesaleState() {
    if (isWholesaleApproved()) {
      if (!document.body.classList.contains('is-wholesale')) {
        document.body.classList.add('is-wholesale');
      }
      // If the gate is open, close it — they're approved
    ...
    // If gate is open, re-render its state (e.g. they just signed in)
    if (gate?.classList.contains('active')) {
      renderGateState();
    }
    // Re-render the active view so prices update everywhere
    ...
    if (activeView?.id === 'view-product') {
      ...
      const brandSlug = document.getElementById('brand-crumb')?.textContent
  ...
  function openGate() {
    // If user is already approved, no need to show the gate
    if (isWholesaleApproved()) {
      showToast('Wholesale access already active');
      return;
    }
    renderGateState();
  ...
  // STATE A (logged out): "Sign in" → open the existing Clerk auth modal
  document.getElementById('gate-signin-btn')?.addEventListener('click', () => {
    closeGate();
    openAuthModal('signin');
  });

  // STATE A & B: "Apply for access" → open the Formspree apply modal
  function openApplyFromGate() {
    closeGate();
    openApplyModal();
  }
  document.getElementById('gate-apply-btn-a')?.addEventListener('click', openApplyFromGate);
  document.getElementById('gate-apply-btn-b')?.addEventListener('click', openApplyFromGate);

  // STATE B: "Sign out" — let them sign out from the gate if they got here by mistake
  document.getElementById('gate-signout-btn')?.addEventListener('click', async () => {
    try {
      await window.Clerk?.signOut();
      renderGateState();
  ...
  // Exit wholesale mode — this just temporarily hides wholesale pricing
  // for the session (doesn't revoke the Clerk flag).
